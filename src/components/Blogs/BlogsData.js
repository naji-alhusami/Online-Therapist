...
const Blogs = [
  ...
  },
  {
    ...
    paragraph2:
      'Common symptoms of anxiety include restlessness, difficulty concentrating, racing thoughts, irritability, and sleep disturbance. Physical symptoms can also arise, such as sweating, rapid heartbeat, and upset stomach. If you are experiencing any of these symptoms and they are disrupting your daily life, it is important to speak with a mental health professional. Treatment options for anxiety include therapy, medication, or a combination of both. It is important to work with a mental health professional to determine the best treatment plan for your specific needs.',
    paragraph3:
  ...
  },
  {
    ...
    paragraph2:
      'Forgiveness is a personal choice and the process of forgiving oneself or others for past hurt or wrongdoings can be a critical step in the healing journey. It is important to note that forgiveness does not mean forgetting or excusing the harm that was caused, but rather it is a way to let go of anger and resentment and move forward. Forgiveness can also bring a sense of peace and closure, and can ultimately help to free you from the negative emotions that may be holding you back from fully healing.',
    paragraph3:
      'it is important to remember that healing from trauma is a journey and it is okay to take things one step at a time. There may be setbacks and difficult days, but with self-care, support, and time, it is possible to move forward and find hope and healing. It is also important to be gentle with yourself and to allow yourself to feel a range of emotions as you work through the healing process. Remember, healing is a process, not a destination, and it is okay to seek help and support whenever you need it.',
  },
  // {
  //   id: 4,
  //   name: 'Blog 1',
